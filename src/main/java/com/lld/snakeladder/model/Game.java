package com.lld.snakeladder.model;
...
public class Game {
    ...
    private Queue<com.lld.snakeladder.model.Player> players;
    ...
    public void addPlayer(com.lld.snakeladder.model.Player player) {
        players.add(player);
    }

    public void playGame() {
        while (true) {
            com.lld.snakeladder.model.Player player = players.poll();
            int val = dice.roll();
